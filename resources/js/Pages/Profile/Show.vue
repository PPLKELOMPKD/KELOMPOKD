...
<template>
    ...
    <SikaraLayout
        title="Profil Saya"
        subtitle="Kelola identitas akademik, keterampilan, dan dokumen karier Anda."
    >
        <template #headerAction>
            <button
                type="button"
                class="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#2563EB] px-5 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(37,99,235,0.18)] transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
        ...
        <div class="grid gap-6 xl:grid-cols-12">
            ...
            <div class="space-y-6 xl:col-span-8">
                <section class="rounded-[20px] border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.04)] md:p-8">
                    ...
                    <p class="mt-5 text-base leading-8 text-[#334155]">
                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    <section class="rounded-[20px] border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.04)] md:p-8">
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <button
                                type="button"
                                class="rounded-full px-3 py-1.5 text-sm font-semibold text-[#2563EB] transition hover:bg-blue-50"
