                ...
                <div class="relative">
                    ...
                    >
                        ...
                        <div class="hidden text-left sm:block">
                            <p class="text-sm font-semibold leading-tight text-[#0F172A]">{{ user?.name || 'Guest' }}</p>
                            <p class="text-xs text-[#64748B] capitalize">{{ user?.role || 'Pengunjung' }}</p>
                        </div>
