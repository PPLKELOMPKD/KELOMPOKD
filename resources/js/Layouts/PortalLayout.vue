                            ...
                            <div v-if="showUserMenu" class="absolute right-0 mt-3 w-64 origin-top-right rounded-2xl border border-[#E2E8F0] bg-white p-2 shadow-2xl shadow-blue-900/5 z-50" @mouseleave="closeUserMenu">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <template v-else>
                                        ...
                                        <Link :href="route('my-events')" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-[#344054] hover:bg-[#EFF6FF] hover:text-[#2563EB] transition-colors">
